...
# Преобразование размерности для LogisticRegression
...
prediction_single = logistic_model.predict([sample_image])  # Передача одного изображения
...
print("Model Size:", logistic_model.coef_.nbytes, "bytes")  # Размер модели в байтах
